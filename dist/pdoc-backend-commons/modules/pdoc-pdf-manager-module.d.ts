...
export declare class PagePdfManagerModule extends CommonDocPdfManagerModule<PDocDataService> {
    ...
    protected exportCommonDocRecordPdfFile(mdoc: CommonDocRecord, action: string, exportDir: string, exportName: string, processingOptions: ProcessingOptions): Promise<import("@dps/mycms-commons/dist/search-commons/services/cdoc-export.service").ExportProcessingResult<CommonDocRecord>>;
